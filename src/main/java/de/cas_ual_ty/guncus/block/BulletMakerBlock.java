...
public class BulletMakerBlock extends MakerBlock
{
    public static final ITextComponent TITLE = new TranslationTextComponent("container." + GunCus.MOD_ID + ".bullet_maker");
    
    public BulletMakerBlock(Properties properties)
    {
        super(properties);
    }
    ...
    {
        return new BulletMakerContainer(windowId, playerInv, pos);
    }
